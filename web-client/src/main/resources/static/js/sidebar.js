function open_sidebar() {
    ...
    if (mediaQuery.matches) {
        document.getElementById("grid").style.gridTemplateColumns = "100%"
        ...
        document.getElementById("grid").style.gridTemplateColumns = "15% 60% 25%"
    }
...
function close_sidebar() {
    ...
    const mediaQuery = window.matchMedia('(max-width: 1199px)');
    if (mediaQuery.matches) {
        document.getElementById("grid").style.gridTemplateColumns = "7% 86%"
        ...
        document.getElementById("grid").style.gridTemplateColumns = "5% 70% 25%"
    }
