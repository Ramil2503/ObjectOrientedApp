function open_sidebar() {
    ...
    if (mediaQuery.matches) {
        document.getElementById("grid_checkout").style.gridTemplateColumns = "100%"
        ...
        document.getElementById("grid_checkout").style.gridTemplateColumns = "15% 80% 5%"
    }
...
function close_sidebar() {
    ...
    const mediaQuery = window.matchMedia('(max-width: 1199px)');
    if (mediaQuery.matches) {
        document.getElementById("grid_checkout").style.gridTemplateColumns = "5% 90% 5%"
